...
Open an issue at https://github.com/TaN-MM-Org/hamop/issues. For a
...
4. hamop ships no material constants by design (only fundamental
   constants, cited to CODATA). If a change introduces a physical
   number, it must carry a full citation in the docstring; uncited
